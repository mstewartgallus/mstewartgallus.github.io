...
[<Abbr>MDX</Abbr>](https://mdxjs.com/), a Markdown processor lets you
insert React components into Markdown, is interesting but has some
major caveats that make it a little awkward sometimess.  In
