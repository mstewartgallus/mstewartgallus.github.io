...
---
import { A, Abbr, Dl, Dt, Dd, DlDiv } from "@features/ui";

- [I'm Looking For](#im-looking-for)
...
Web development, security, formal methods, programming language
theory.
...
In 2023 I have ported over my poetry blog to [Gatsby](gatsbyjs.com).
...
I got heavily into low-level details of the <Abbr>JVM</Abbr> for a
